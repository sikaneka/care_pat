      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Image.network(
              'https://th.bing.com/th/id/OIP.tQHLB9Nxh9IsWk-eN2N5OwHaE3?rs=1&pid=ImgDetMain',
            ...
            Consumer<Loginprovider>(builder: (context, value, child) {
              return value.temp
                  ? Text(
                      "Current temperature : ${value.templist.last.toString()}°C. \n"
                  ...
                  : Text(
                      "Current temperature : ${value.templist.last.toString()}°C.\n"
                      "Body temperature's a bit off today. Together, let's work on getting it back to track.",
                      style: TextStyle(
                          fontSize: 22,
                          color: Color.fromARGB(255, 163, 93, 66),
                          fontFamily: 'serif'),
